...
void spe_fit(int pednumber, int runnumber, int board){
  ...
  TFile *fout = new TFile(Form("spe_result/spe_result_ped%d_led%d_board%d.root",pednumber,runnumber,board), "RECREATE");
