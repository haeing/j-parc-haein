...
BACDetectorConstruction_edep::BACDetectorConstruction_edep(const G4String &par4)
  : G4VUserDetectorConstruction(),parameter4(par4)
{
}

BACDetectorConstruction_edep::~BACDetectorConstruction_edep()
{
...
G4VPhysicalVolume* BACDetectorConstruction_edep::Construct()
{
...
void BACDetectorConstruction_edep::ConstructSDandField()
{
