...
static const double beam_mom[5] = {705.,715.,725.,745.};
static const double beam_mom_fix = 735.;

static const double FK = 2.5*pow(10,4); //# of beam particles per spill 
...
static const double T_fix = 2.5*24*3600/spill_length;
...
static const double Rbeam = 1.0; //ratio of the target upstream face to the cross-sectional area of the beam profile
...
static const double trigger_eff = 0.8*0.6; //DAQ efficiency * recon efficiency
